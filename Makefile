...
help:
	@echo "Rust Transcription - Available Commands"
	@echo "========================================"
	@echo ""
	@echo "Setup:"
	@echo "  make check-prereqs     Check for required tools (git, rustc, cargo, pnpm)"
...
check-prereqs:
	...
	@command -v rustc >/dev/null 2>&1 || { echo "❌ rustc is required but not installed. Visit https://rustup.rs"; exit 1; }
...
start-backend:
	...
	./target/release/rust-transcription
