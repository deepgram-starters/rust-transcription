...
Rust (Axum) demo app for Deepgram Transcription.
...
```
feat(rust-transcription): add diarization support
fix(rust-transcription): resolve WebSocket close handling
refactor(rust-transcription): simplify session endpoint
